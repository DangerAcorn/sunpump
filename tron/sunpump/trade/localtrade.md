...
| `privateKey`   | string | Yes      | Your Wallet Private Key (use a fresh wallet)                             |
...
\
If you would prefer to build transactions instead of sending your Private Key through an HTTPS request, please refer to `Local Trade API`
{% endhint %}
